...
Reference: [awesome-semantic-segmentation-pytorch](https://github.com/Tramac/awesome-semantic-segmentation-pytorch)

Please organized files as following structure
```
...
Please run under directory `awesome-semantic-segmentation-pytorch` with command `python ./scripts/train.py --model deeplabv3 --backbone resnet50 --dataset foodrecognition --lr 0.0001 --epochs 50 --save-dir './checkpoints' --save-epoch 1`
