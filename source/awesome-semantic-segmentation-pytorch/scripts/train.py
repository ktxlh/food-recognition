...
def parse_args():
    ...
    parser.add_argument('--dataset', type=str, default='pascal_voc',
                        choices=['pascal_voc', 'pascal_aug', 'ade20k', 'citys', 'sbu', 'foodrecognition'],
...
class Trainer(object):
    ...
    def train(self):
        ...
        # print("log_per_iters:", log_per_iters, " val_per_iters:", val_per_iters, " self.args.skip_val:", self.args.skip_val)
        # log_per_iters: 10  val_per_iters: 13579  self.args.skip_val: False

        # print("save_to_disk:", save_to_disk, " self.args.save_epoch:", self.args.save_epoch, " self.args.iters_per_epoch:", self.args.iters_per_epoch)
        # save_to_disk: True  self.args.save_epoch: 10  self.args.iters_per_epoch: 13579


        self.model.train()
        for iteration, (images, targets, _) in enumerate(self.train_loader):
            # print("trainer.train() iteration:", iteration)
...
def save_checkpoint(model, args, is_best=False):
    ...
    # print("save_checkpoint-  directory:", directory, " filename:", filename)
